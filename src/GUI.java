...
public abstract class GUI {
	...
	protected abstract void modeFindAllConnectedAP();
	protected abstract void modeFindAllAP();
	protected abstract void modeFindConnectedMST();
	protected abstract void modeFindAllMST();
	...
	private void initialise() {
		...
		JButton allAP = new JButton("Find All APs");
		allAP.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				modeFindAllAP();
				redraw();
			}
		...
		JButton allMST = new JButton("Find All MST");
		allMST.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				modeFindAllMST();
				redraw();
			}
		...
		JButton connectedAP = new JButton("Find Connected APs");
		connectedAP.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				modeFindAllConnectedAP();
				redraw();
			}
		});

		JButton connectedMST = new JButton("Find Connected MST");
		connectedMST.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				modeFindConnectedMST();
				redraw();
			}
		});
		...
		JPanel articulationpoint = new JPanel();
		articulationpoint.setLayout(new GridLayout(2, 1));
		// manually set a fixed size for the panel containing the load and quit
		// buttons (doesn't change with window resize).
		articulationpoint.setMaximumSize(new Dimension(50, 100));
		articulationpoint.add(allAP);
		articulationpoint.add(connectedAP);
		controls.add(articulationpoint);

		JPanel minimumspanningtree = new JPanel();
		minimumspanningtree.setLayout(new GridLayout(2, 1));
		// manually set a fixed size for the panel containing the load and quit
		// buttons (doesn't change with window resize).
		minimumspanningtree.setMaximumSize(new Dimension(50, 100));
		minimumspanningtree.add(allMST);
		minimumspanningtree.add(connectedMST);
		controls.add(minimumspanningtree);
